...
jQuery(document).ready(function($) {
    ...
    function quick_post(post, type) {
        var new_title = jQuery('#title-'+post).val();
        var new_excerpt = jQuery('#excerpt-'+post).val();
        var new_note = jQuery('#note-'+post).val();
        var nonce = jQuery('input#_wpnonce').val();
    ...
    function myc_nb_move() {
        ...
        var new_note = jQuery('#mct-nb-notes').val();
        var notebk = jQuery('select#mct-nb-select option:selected').val();
        var newnbstr = jQuery('#mct-nb-newnb').val();
